...
def ai_gen(input1):
    ...
    if input1 == '1' or input1 == '2':
        ...
        prompt_body = f'Dont include salutations and greetings. Generate the body of an email with respect to {prompt_subject}, but not more than 40 words.Do NOT USE DATE AND TIME in the email.DO NOT CREATE EMAIL SUBJECT.'
